...
func TestParseReference(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "loopback range", raw: "https://127.0.0.2/model.gguf", wantErr: "runner container cannot reach"},
		{name: "ipv6 loopback", raw: "https://[::1]:8443/model.gguf", wantErr: "runner container cannot reach"},
		{name: "localhost subdomain", raw: "https://models.localhost/model.gguf", wantErr: "runner container cannot reach"},
