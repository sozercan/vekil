...
func runServe() {
	...
	metricsEnabled := flag.Bool("metrics", getEnvBool("METRICS", true), "Enable Prometheus metrics endpoint (/metrics)")
	noMetrics := flag.Bool("no-metrics", false, "Disable Prometheus metrics endpoint (/metrics)")
