...
| [`grafana-dashboard.json`](grafana-dashboard.json) | starter Grafana dashboard for `/metrics` Prometheus data | Prometheus metric names, labels, or recommended panels change |
