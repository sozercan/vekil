...
| [`conversation-migration.md`](conversation-migration.md) | opt-in Azure Responses migration, complete visible history, local tools, continuation/reconnect, storage privacy and deletion | migration configuration, completeness, safety, diagnostics or history retention changes |
