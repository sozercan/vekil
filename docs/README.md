...
| [`code-execution.md`](code-execution.md) | optional proxy-mediated code execution: owned tool interception, backends, policy controls | code-execution mode config, backends, or loop behavior changes |
