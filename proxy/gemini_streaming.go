...
func StreamOpenAIToGemini(w http.ResponseWriter, body io.ReadCloser) {
	StreamOpenAIToGeminiObserved(w, body, nil)
}

// StreamOpenAIToGeminiObserved translates upstream OpenAI SSE into Gemini-style
// data-only SSE frames while optionally recording upstream usage.
func StreamOpenAIToGeminiObserved(w http.ResponseWriter, body io.ReadCloser, onUsage func(*models.OpenAIUsage)) {
