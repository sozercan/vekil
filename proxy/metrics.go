...
func (h *ProxyHandler) HandleMetrics(w http.ResponseWriter, r *http.Request) {
	...
	_, _ = fmt.Fprintln(w, "# HELP vekil_request_latency_milliseconds Recent request latency quantiles in milliseconds.")
	_, _ = fmt.Fprintln(w, "# TYPE vekil_request_latency_milliseconds gauge")
