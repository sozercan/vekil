...
func TestPeekAndForwardResponses_FailsOpenOnMaxPeekBytes(t *testing.T) {
	...
	peekAndForwardResponsesWithConfig(h, w, req, resp, func() {}, "gpt-5.4", nil, requestMetricLabels{}, 50*time.Millisecond, 32)
...
func TestPeekAndForwardResponses_FailsOpenOnPeekTimeout(t *testing.T) {
	...
	peekAndForwardResponsesWithConfig(h, w, req, resp, func() {}, "gpt-5.4", nil, requestMetricLabels{}, 20*time.Millisecond, 1024)
...
func TestPeekAndForwardResponses_ClientDisconnectDuringPeekClosesUpstream(t *testing.T) {
	...
	go func() {
		defer close(done)
		peekAndForwardResponsesWithConfig(h, w, req, resp, func() {}, "gpt-5.4", nil, requestMetricLabels{}, time.Second, 1024)
	}()
